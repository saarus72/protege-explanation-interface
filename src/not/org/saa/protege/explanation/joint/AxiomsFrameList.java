...
public class AxiomsFrameList extends OWLFrameList<Explanation<OWLAxiom>> {
	...
	public AxiomsFrameList(AxiomSelectionModel axiomSelectionModel, PresentationManager manager, OWLFrame<Explanation<OWLAxiom>> explanationOWLFrame) {
...
//                    if(manager.getJustificationCount(entailment) > 1) {
...
//        int count = manager.getJustificationCount(entailment);
//
